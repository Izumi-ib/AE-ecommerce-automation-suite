...
public class cart_product_details {
    ...
    public void user_verifies_that_each_product_has_the_prices_quantity_and_total_price(String string, String string2, String string3) {
        cartPage.verifyProductsDetails();
    }
